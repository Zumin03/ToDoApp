        ...
        <form onSubmit={handleCreateTodo} className="mt-8 space-y-4">
          <div>
            <input
              ...
              className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
              required
            />
          </div>
          <div>
